...
function remediationForBlocker(id) {
  ...
  if (id === "registrarController.commitmentWindow") return "Deploy a replacement RegistrarController with a non-zero minimum commitment age and a maximum greater than the minimum; the current values are immutable. Then update the configured address, controller permissions, deployment evidence, and fresh on-chain probes.";
